...
use App\Models\ChurchPassReset as PassReset;
use App\Models\User;
...
class ChurchPasswordReset extends Component
{
    ...
    */
    ...
    {
        return view('livewire.church.pages.church-password-reset');
    }
}
