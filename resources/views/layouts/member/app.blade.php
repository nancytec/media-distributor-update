    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{Auth::guard('member')->user()->ImagePath}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('member.links')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Media
                                <span class="right badge badge-success">links</span>
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a target="_blank" href="{{route('member.generate-media-link')}}" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>
                                Generate
                                <span class="right badge badge-primary">Media link</span>
                            </p>
                        </a>
                    </li>
                </ul>
