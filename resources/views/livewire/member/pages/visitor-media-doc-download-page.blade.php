...
<div class="login-box">
        ...
        @if($media)
            ...
            <option value="INDONESIA">INDONESIA</option>
                        <option value="IRISH GAELIC">IRISH GAELIC</option> 
                            ...
                            <option value="SAMOAN">SAMOAN</option> <option value="SCOTTISH GAELIC">SCOTTISH GAELIC</option>
    ...
    <option value="URDU">URDU</option><option value="UUNGA">UUNGA</option>
    <option value="VENDA">VENDA</option> <option value="WEH">WEH</option>
    <option value="WELSH">WELSH</option> 
    <option value="XHOSA">XHOSA</option>
    <option value="Afrikaans">Afrikaans</option>
                                    <option value="Arabic">Arabi</option><option value="Benbe">Bemba</option>
                                            <option value="Bende">Bende</option>
                                            <option value="Brazilian portuguese">Brazilian portuguese</option>
                                            <option value="Bwile">Bwile</option>
                                            <option value="Cantonese">Cantonese</option> <option value="Chichewa">Chichewa</option>
                    ...
                    <div class="form-group">
                        ...
                        @if($trans_preview)
                            <button  type="button" data-toggle="modal" data-target="#modal-lg" class="btn btn-warning" >Preview</button>
                        @endif
                    </div>
                </form>
