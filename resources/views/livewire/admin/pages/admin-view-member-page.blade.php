                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <p style="text-align: center; font-size: 70%;"><a href="{{route('admin.church-view', $member->church->id)}}" style="color: white;"> {{$member->church->name}}</a></p>
                                    ...
                                    <div class="timeline timeline-inverse">
                                        ...
                                        <div class="time-label">
                                            <span class="bg-primary">
                                              ...
                                              Shared: @if($member->media) {{count($member->media)}} @else 0 @endif
                                            </span>
                                        </div>
                                        <!-- /.timeline-label -->
                                        <!-- timeline item -->
